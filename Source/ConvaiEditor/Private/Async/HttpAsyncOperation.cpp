...
namespace ConvaiEditor
{
        ...
        TSharedPtr<IAsyncProgressReporter> Progress)
    {
        ...
        HttpRequest->OnProcessRequestComplete().BindLambda(
            [&bRequestCompleted, &bRequestSuccess, &HttpResponse](FHttpRequestPtr Req, FHttpResponsePtr Response, bool bSuccess)
            {
                if (!Req.IsValid())
                {
        ...
        FHttpAsyncResponse Response = ConvertHttpResponse(HttpResponse);
