...
class CONVAIVISIONBASE_API UEnvironmentWebcame : public UConvaiWebcamBase
{
	GENERATED_BODY()
public:
	UEnvironmentWebcame(const FObjectInitializer& ObjectInitializer);
...
protected:
	...
	void CopyPostProcessPropertiesFromVolume();
};
