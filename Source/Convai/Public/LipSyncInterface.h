...
public:
	...
	/**
	 * Returns true if the lipsync system currently has frames it can produce
	 * (i.e. a sequence is loaded, not paused, and the playback time hasn't
	 * exceeded the buffered duration). Non-buffered real-time systems should
	 * return true (the default).
	 */
	virtual bool HasPlayableFrames() const { return true; }
