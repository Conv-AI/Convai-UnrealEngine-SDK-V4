...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintCallable, Category = "Convai|Utilities", meta = (WorldContext = "WorldContextObject"))
	static class UConvaiPlayerComponent* GetFirstConvaiPlayerComponent(UObject* WorldContextObject);
	...
	UFUNCTION(BlueprintPure, BlueprintCallable, Category = "Convai|Utilities", meta = (WorldContext = "WorldContextObject"))
	static class UConvaiChatbotComponent* GetFirstConvaiChatbotComponent(UObject* WorldContextObject);
