...
public:
	 ...
	 *                       distance to the nearest point on that footprint
	 *                       within the raw Acceptance Radius, so wide objects
	 *                       do not false-negative just because their centre is
	 *                       far from the standing point. Either way
