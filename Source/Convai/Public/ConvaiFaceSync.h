...
public:
	...
	virtual TArray<FString> ConvaiGetFacialDataNames() override;
	virtual EC_LipSyncMode GetLipSyncMode() override;
	virtual bool GeneratesFacialDataAsBlendshapes() override;
	...
	EC_LipSyncMode LipSyncMode = EC_LipSyncMode::Off;
...
protected:
	//~ Recording Helpers
	void AddFrameToRecordingBuffer(const FAnimationFrame& Frame, float Duration);
