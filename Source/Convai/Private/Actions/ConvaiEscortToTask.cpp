...
namespace
{
	...
	FString EscortEntryLabel(const FConvaiObjectEntry& Entry, const TCHAR* Fallback)
	{
		...
		const FConvaiObjectEntry& Destination)
	{
		return FString::Printf(
			...
			*EscortEntryLabel(Destination, TEXT("the destination")));
	}
		...
		const FConvaiObjectEntry& Escortee)
	{
		return FString::Printf(
			...
			*EscortEntryLabel(Escortee, TEXT("the escorted character")));
	}
}
