...
private:
	...
	virtual void OnParticipantConnected(FString ParticipantId) override;
	virtual void OnParticipantDisconnected(FString ParticipantId) override;
	...
	void SafeProcessAudioData(const int16* AudioData, int32 NumSamples, int32 SampleRate);
