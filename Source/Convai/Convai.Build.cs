...
public class Convai : ModuleRules
{
    ...
    public Convai(ReadOnlyTargetRules Target) : base(Target)
    {
        ...
        PublicDefinitions.Add("WITH_CONVAI_TESTS=1");
        ...
        PublicDependencyModuleNames.AddRange(new string[] { "Core", "CoreUObject", "Engine", "InputCore", "Json", "JsonUtilities", "AudioMixer", "AudioCaptureCore", "AudioCapture", "Voice", "SignalProcessing", "libOpus", "OpenSSL", "zlib", "SSL", "NavigationSystem", "UMG", "Slate", "SlateCore" });
        PrivateDependencyModuleNames.AddRange(new string[] {"Projects"});
        PublicDefinitions.AddRange(new string[] { "ConvaiDebugMode=1" });
