...
void UConvaiTestHarnessSubsystem::RegisterBuiltinTests()
{
	...
	RegisterTestClass(TEXT("ActionResponse"), UConvaiTest_ActionResponse::StaticClass());
	RegisterTestClass(TEXT("KnowledgeBank"), UConvaiTest_KnowledgeBank::StaticClass());
}
