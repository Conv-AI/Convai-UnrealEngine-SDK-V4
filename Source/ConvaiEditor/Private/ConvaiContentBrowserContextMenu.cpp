...
void FConvaiContentBrowserContextMenu::ApplyCharacterMovementDefaults(UCharacterMovementComponent *Comp)
{
	...
	// On 5.0–5.4 the same fields exist on UNavMovementComponent but are protected, so we
	// can't set them from here — skipped (this is just default styling for the spawned actor).
