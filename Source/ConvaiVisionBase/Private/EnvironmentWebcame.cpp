...
void UEnvironmentWebcame::BeginPlay()
{
    Super::BeginPlay();
...
void UEnvironmentWebcame::CopyPostProcessPropertiesFromVolume()
{
    ...
    if (!World)
    {
        UE_LOG(LogTemp, Warning, TEXT("UEnvironmentWebcame::CopyPostProcessPropertiesFromVolume - World is null"));
        return;
    }
    ...
    {
        UE_LOG(LogTemp, Warning, TEXT("UEnvironmentWebcame::CopyPostProcessPropertiesFromVolume - No PostProcessVolume found in the world"));
        return;
    }
    ...
    UE_LOG(LogTemp, Log, TEXT("UEnvironmentWebcame::CopyPostProcessPropertiesFromVolume - Successfully copied post-process properties from PostProcessVolume"));
}