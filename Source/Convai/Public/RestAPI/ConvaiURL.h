...
enum class EConvaiEndpoint : uint8
{
    ...
    KnowledgeBankUpload UMETA(DisplayName = "Knowledge Bank Upload"),
    KnowledgeBankUpdate UMETA(DisplayName = "Knowledge Bank Update"),
    KnowledgeBankList UMETA(DisplayName = "Knowledge Bank List"),
    KnowledgeBankDelete UMETA(DisplayName = "Knowledge Bank Delete")
};
...
private:
    ...
    static const TCHAR KNOWLEDGE_BANK_SUBDOMAIN[];
