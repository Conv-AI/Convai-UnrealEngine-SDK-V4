...
public:
	...
	static bool GetRawImageDataFromRenderTarget(UTextureRenderTarget2D* RenderTarget, TArray<uint8>& OutData, int32& OutWidth, int32& OutHeight);
	
	static bool TextureRenderTarget2DToBytes(UTextureRenderTarget2D* TextureRenderTarget2D, const EImageFormat ImageFormat, TArray<uint8>& ByteArray, const int32 CompressionQuality = 0);
