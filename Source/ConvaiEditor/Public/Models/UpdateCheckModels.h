...
struct CONVAIEDITOR_API FUpdateCheckConfig
{
	...
	static FUpdateCheckConfig Default()
	{
		...
		Config.GitHubLatestApiUrl = TEXT("https://api.github.com/repos/Conv-AI/Convai-UnrealEngine-SDK-V4/releases/latest");
		Config.GitHubAllReleasesApiUrl = TEXT("https://api.github.com/repos/Conv-AI/Convai-UnrealEngine-SDK-V4/releases");
		Config.GitHubReleasesUrl = TEXT("https://github.com/Conv-AI/Convai-UnrealEngine-SDK-V4/releases");
		Config.TimeoutSeconds = 10.0f;
		Config.MaxRetries = 2;
		Config.RetryDelaySeconds = 2.0f;
		Config.CacheTTLSeconds = 3600.0f;
		Config.bAutoCheckOnStartup = true;
		Config.bIncludePreReleases = true;
		return Config;
	}
};
