...
public:
	...
	*/
	...
	void SetContextState(const FString& Name, const FString& Value, EC_RunLLMOption ShouldRespond = EC_RunLLMOption::Never);
	...
	void SetContextStates(const TMap<FString, FString>& States, EC_RunLLMOption ShouldRespond = EC_RunLLMOption::Never);
	...
	void AddContextEvent(const FString& Text, EC_RunLLMOption ShouldRespond = EC_RunLLMOption::Auto);
