...
private:    
    ...
    // Latency tracking for user-stopped-speaking to bot-started-speaking
    double UserStoppedSpeakingTimestamp;
    bool bUserStoppedSpeakingPending;
    TArray<double> ResponseLatencies;
...
// Client callbacks
    ...
    // Helper functions
    void OnUserStartedSpeaking(const char* attendee_id);
    void OnUserStoppedSpeaking(const char* attendee_id);
    ...
    void OnBotStartedSpeaking(const char* attendee_id);
