...
public class Convai : ModuleRules
{
    ...
    public Convai(ReadOnlyTargetRules Target) : base(Target)
    {
        ...
        // WITH_CONVAI_TESTS=1 enables the in-plugin integration test harness under Source/Convai/{Public,Private}/Tests.
        // Set to 0 (or delete the Tests folders) to strip all test code from shipping builds.
        PublicDefinitions.Add("WITH_CONVAI_TESTS=0");
