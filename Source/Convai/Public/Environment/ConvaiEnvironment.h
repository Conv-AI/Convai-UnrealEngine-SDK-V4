...
struct CONVAI_API FConvaiEnvironmentData
{
	 ...
	 *  Defaults cover the common movement beats and include a disabled Escort example;
	 *  designers can enable, prune, extend, or reword them per character. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Convai|Action API",
		meta = (EditCondition = "bEnableActions", TitleProperty = "Name"))
