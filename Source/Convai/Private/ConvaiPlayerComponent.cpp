...
void UConvaiPlayerComponent::CheckMicCaptureHealth()
{
	...
	{
		CONVAI_LOG(ConvaiPlayerLog, Warning, TEXT("Microphone capture failed to open after %d attempts - check RECORD_AUDIO permission and that no other app holds the mic"), MicOpenRetryCount);
		return;
	}
