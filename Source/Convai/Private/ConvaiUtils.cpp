...
UConvaiPlayerComponent* UConvaiUtils::GetFirstConvaiPlayerComponent(UObject* WorldContextObject)
{
	TArray<UConvaiPlayerComponent*> Components;
	ConvaiGetAllPlayerComponents(WorldContextObject, Components);
	return Components.Num() > 0 ? Components[0] : nullptr;
}

UConvaiChatbotComponent* UConvaiUtils::GetFirstConvaiChatbotComponent(UObject* WorldContextObject)
{
	TArray<UConvaiChatbotComponent*> Components;
	ConvaiGetAllChatbotComponents(WorldContextObject, Components);
	return Components.Num() > 0 ? Components[0] : nullptr;
}
