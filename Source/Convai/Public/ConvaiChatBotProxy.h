...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FBotGetCharsHttpResponseCallbackSignature, const TArray<FString>&, CharIDs, const TArray<FConvaiAvatarInfo>&, Characters);

UCLASS()
class CONVAI_API UConvaiChatBotGetCharsProxy : public UOnlineBlueprintCallProxyBase
{
	GENERATED_BODY()
...
public:
	...
	TArray<FConvaiAvatarInfo> Characters;
