...
void UConvaiConnectionSessionProxy::UpdateContext(const FString& Text, EC_ContextUpdateMode Mode, EC_RunLLMOption ShouldRespond) const
{
    if (const UConvaiSubsystem* ConvaiSubsystem = UConvaiUtils::GetConvaiSubsystem(this))
    {
        ConvaiSubsystem->UpdateContext(this, Text, Mode, ShouldRespond);
    }
}
