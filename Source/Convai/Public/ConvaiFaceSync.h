...
public:
	...
	virtual TArray<FString> ConvaiGetFacialDataNames() override { return GeneratesFacialDataAsBlendshapes() ? ConvaiConstants::MetaHumanCtrlNames : ConvaiConstants::VisemeNames; }
	...
	virtual bool GeneratesFacialDataAsBlendshapes() override { return UConvaiUtils::IsToggleBlendshapeOrViseme(ToggleBlendshapeOrViseme); }
	...
	{
		return GeneratesFacialDataAsBlendshapes() ? ConvaiConstants::MetaHumanCtrlNames : ConvaiConstants::VisemeNames;
	}
	...
	// False means visemes; true means blendshapes aka neuro sync
	// TODO : Refactor it enum
	UPROPERTY(EditAnywhere, Category = "Convai|LipSync")
