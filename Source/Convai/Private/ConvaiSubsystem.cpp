...
void UConvaiSubsystem::UpdateContext(const UConvaiConnectionSessionProxy* SessionProxy, const FString& Text, EC_ContextUpdateMode Mode, EC_RunLLMOption ShouldRespond) const
{
    if (!IsValid(SessionProxy) || !ConvaiClient || !bIsConnected)
    {
        return;
