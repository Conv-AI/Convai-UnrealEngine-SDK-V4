...
namespace ConvaiEditor::Configuration::Defaults
{
    ...
    namespace Values
    {
        ...
        // `inline const` (not constexpr) because the source constants in
        // Constants::Layout::Window are themselves not constexpr — clang 20
        // under UE 5.8 enforces this where 5.7 quietly accepted it.
        inline const int32 WINDOW_INITIAL_WIDTH = static_cast<int32>(Constants::Layout::Window::MainWindowWidth);
        inline const int32 WINDOW_INITIAL_HEIGHT = static_cast<int32>(Constants::Layout::Window::MainWindowHeight);
        inline const float WINDOW_MIN_WIDTH = Constants::Layout::Window::MainWindowMinWidth;
        inline const float WINDOW_MIN_HEIGHT = Constants::Layout::Window::MainWindowMinHeight;
