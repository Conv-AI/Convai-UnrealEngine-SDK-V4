...
void UConvaiConnectionSessionProxy::UpdateContext(const FString& Text, EC_ContextUpdateMode Mode, EC_RunLLMOption RunLLM) const
{
    if (const UConvaiSubsystem* ConvaiSubsystem = UConvaiUtils::GetConvaiSubsystem(this))
    {
        ConvaiSubsystem->UpdateContext(this, Text, Mode, RunLLM);
    }
}
