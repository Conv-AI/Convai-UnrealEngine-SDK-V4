 ...
 *   - Interfaces / classes / delegates / soft refs. Object references to
 *     sub-actors, components, and instanced subobjects ARE offered as
 *     drill-down (the runtime hops across them with IsValid checks every
 *     poll) but never as leaves; all other object refs stay closed.
